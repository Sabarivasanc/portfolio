  ...
  return (
    <section id="home" className="relative min-h-screen pt-24 pb-16 px-6 flex items-center overflow-hidden">
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div 
            className="order-2 lg:order-1 z-10 lg:pl-8" // Added lg:pl-8 here
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, ease: "easeOut" }}
          >
            ...
            >
              <a 
                href="https://github.com/Sabarivasanc" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2 rounded-full bg-background social-icon transition-all"
                aria-label="GitHub Profile"
              ...
              <a 
                href="https://www.linkedin.com/in/sabarivasan-c-a78267274/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2 rounded-full bg-background social-icon transition-all"
                aria-label="LinkedIn Profile"
              ...
              <a 
                href="https://leetcode.com/u/vsabari146/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2 rounded-full bg-background social-icon transition-all"
                aria-label="LeetCode Profile"
              ...
              <a 
                href="https://www.geeksforgeeks.org/user/vsabara3hq/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2 rounded-full bg-background social-icon transition-all"
                aria-label="GeeksForGeeks Profile"
          ...
          >
            <div className="relative">
              ...
              >
                <p className="text-xs font-medium flex items-center gap-1">
                  <span className="text-primary">GeeksForGeeks:</span> 50+ problems,University Rank 14
                </p>
              </motion.div>
